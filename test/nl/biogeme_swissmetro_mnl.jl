# Replicate the Biogeme Swissmetro example - this is the MNL example, but estimated with the nested logit function;
# with no nests it should be identical.
# https://biogeme.epfl.ch/examples/swissmetro/01logit.html

@testitem "Biogeme swissmetro MNL using NL" begin
    using CSV
    using DataFrames
    ...
    # not implemented for nested logit
