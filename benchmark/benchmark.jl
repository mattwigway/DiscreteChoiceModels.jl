...
function main()
    ...
    should_run("Mixed_Apollo_DataFrame") && (suite["Mixed_Apollo_DataFrame"] = benchmark_mixed_apollo())
    should_run("Mixed_Apollo_macroexpand") && (suite["Mixed_Apollo_macroexpand"] = benchmark_mixed_apollo_macroexpand())
